...
A repository for Duquesne's Data Science DTSC330 course for 2026
...
In VSCode, do NOT open `programming`. Instead, you should have a separate window for `dtsc330_26` and any other project, such as `dtsc330_26`.
...
1. Clone the repository to your computer. I'm going to navigate to the right place in the terminal first and then clone. This will create a new folder in programming with the name `dtsc330_26` in which the project will live.

```
cd /Users/arthur/programming
git clone git@github.com:asugden/dtsc330_26.git dtsc330_26/
```
